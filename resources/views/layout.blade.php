...
<head>
    ...
    <link rel="stylesheet" href="{{asset('build/assets/app-BvmpCcTm.css')}}">`
                    ...
                    <div class="text-start">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <a href="mailto:{{$informationWeb->email}}"
                                    class="hover:text-white transition">{{$informationWeb->email}}</a>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <p class="hover:text-blue-400 transition">{{$informationWeb->telepon}}</p>
                            </div>
                        </div>
                    </div>
