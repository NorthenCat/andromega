        ...
        <div class="flex justify-center pt-10 gap-5">
            <div class="w-full max-w-6xl space-y-4">
                ...
                'bg-gradient-radial from-[#80439a80] to-[#2c317780]': !open
                        ...
                        <div class="flex justify-between items-center">
                            <p class="font-semibold italic">Bagaimana Andromega memastikan kualitas layanan yang
                                diberikan?</p>
                            <span x-text="open ? '-' : '+'" :class="{ 'text-white': open, 'text-[#f05426]': !open }"
                                class="text-5xl font-medium"></span>
                        </div>
                    ...
                    <div class="w-full max-w-6xl space-y-4">
                        <div x-data="{ open: false }"
                            class="rounded-lg p-4 cursor-pointer transition-colors duration-300" :class="{ 'bg-gradient-radial from-[#80439a] to-[#2c3177] text-white': open,
                'bg-gradient-radial from-[#80439a80] to-[#2c317780]': !open
                }" @click="open = !open">
                            <div class="flex justify-between items-center">
                                <p class="font-semibold italic">Bagaimana Andromega memastikan kualitas layanan yang
